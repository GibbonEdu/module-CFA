...
if (isActionAccessible($guid, $connection2, "/modules/CFA/cfa_manage_add.php")==FALSE) {
	...
	if ($gibbonCourseClassID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/cfa_manage_addProcess.php?gibbonCourseClassID=$gibbonCourseClassID&address=" . $_SESSION[$guid]["address"] ?>" enctype="multipart/form-data">
