				...
				if ($result2->rowCount()!=1) {
					...
					print "<form method='post' action='" . $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/cfa_write_dataProcess.php?gibbonCourseClassID=$gibbonCourseClassID&cfaColumnID=$cfaColumnID&address=" . $_SESSION[$guid]["address"] . "' enctype='multipart/form-data'>" ;
						print "<table class='smallIntBorder' cellspacing='0' style='width: 100%'>" ;
							...
							<tr>
								<td> 
									<b><?php print __($guid, 'Submitted Homework ') ?></b><br/>
														...
														print "<select name='$count-attainmentValue' id='$count-attainmentValue' style='width:50px'>" ;
															...
															while ($rowSelect=$resultSelect->fetch()) {
																if ($rowEntry["attainmentValue"]==$rowSelect["value"]) {
																	print "<option selected value='" . htmlPrep($rowSelect["value"]) . "'>" . htmlPrep(__($guid, $rowSelect["value"])) . "</option>" ;
																}
																else {
																	print "<option value='" . htmlPrep($rowSelect["value"]) . "'>" . htmlPrep(__($guid, $rowSelect["value"])) . "</option>" ;
																}
															}			
														print "</select>" ;
													}
