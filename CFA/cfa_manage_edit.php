			...
			if ($result->rowCount()!=1) {
				...
				if ($result2->rowCount()!=1) {
					...
					if ($highestAction=="Manage CFAs_department") {
						print "<p>" ;
							print __($guid, "You have departmental editing rights, which means you can only edit certain aspects of this CFA column.") ;
						print "</p>" ;
					}
						...
						<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
							...
							if ($row2["groupingID"]!="" AND $highestAction=="Manage CFAs_department") {
								...
								if ($resultGrouped->rowCount()>1) {
									...
									<tr class='break'>
										<td colspan=2> 
											<h3><?php print __($guid, 'Related Columns') ?></h3>
											<p>
												<?php print __($guid, "This column is part of a set of columns within your department: would you like to extend these changes to those columns?") ; ?>
											</p>
										</td>
									</tr>
									<tr>
										...
										<td class="right">
											...
											<?php
											print __($guid, "All/None") . " <input checked type='checkbox' class='checkall'><br/>" ;
