...
if (isActionAccessible($guid, $connection2, "/modules/CFA/cfa_view.php")==FALSE) {
	...
	if ($highestAction==FALSE) {
		...
		if ($highestAction=="View CFAs_all") { //ALL STUDENTS
			...
			print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . __($guid, "Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . __($guid, getModuleName($_GET["q"])) . "</a> > </div><div class='trailEnd'>" .__($guid, 'View All CFAs') . "</div>" ;
			print "</div>" ;
				...
				print "<table class='noIntBorder' cellspacing='0' style='width: 100%'>" ;
					...
					print "<tr>" ;
						print "<td class='right' colspan=2>" ;
							...
							print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/CFA/cfa_view.php'>" . __($guid, 'Clear Filters') . "</a> " ;
			...
			if ($gibbonPersonID) {
				...
				if ($resultCheck->rowCount()!=1) {
					...
					print getCFARecord($guid, $connection2, $gibbonPersonID) ;
				}
			}			
		}
		else if ($highestAction=="View CFAs_myChildrens") { //MY CHILDREN
			print "<div class='trail'>" ;
			print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . __($guid, "Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . __($guid, getModuleName($_GET["q"])) . "</a> > </div><div class='trailEnd'>" .__($guid, 'View My Childrens\'s CFAs') . "</div>" ;
			print "</div>" ;
						...
						print "<table class='noIntBorder' cellspacing='0' style='width: 100%'>" ;
							...
							<tr>
								<td colspan=2 class="right">
									...
									<?php
									print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/CFA/cfa_view.php'>" . __($guid, 'Clear Search') . "</a>" ;
									?>
			...
			print "<div class='trail'>" ;
			print "<div class='trailHead'><a href='" . $_SESSION[$guid]["absoluteURL"] . "'>" . __($guid, "Home") . "</a> > <a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . getModuleName($_GET["q"]) . "/" . getModuleEntry($_GET["q"], $connection2, $guid) . "'>" . __($guid, getModuleName($_GET["q"])) . "</a> > </div><div class='trailEnd'>" .__($guid, 'View My CFAs') . "</div>" ;
			print "</div>" ;
			...
			print getCFARecord($guid, $connection2, $_SESSION[$guid]["gibbonPersonID"]) ;
		}
	}
}		
?>